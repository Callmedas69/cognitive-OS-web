...
One-time setup. A 3-question wizard generates your filesystem: the zone folders, `memory.md`, and the agent routing files (`AGENTS.md` + `CLAUDE.md`).
...
Prints **Mission Control** to your terminal — a snapshot of where you left off, read straight from `memory.md`: current focus, blockers, and open loops. Renders in under half a second.
...
- [Hooks](/docs/hooks) — the automation that updates `memory.md` for you.
